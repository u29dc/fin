...
CERT_FIN_HOME="$fin_home" RESET_DB=1 "$repo_root/scripts/cert/reset_fixtures.sh" valid >/dev/null
FIN_HOME="$fin_home" bun run build >/dev/null
...
CERT_FIN_HOME="$fin_home" RESET_DB=1 "$repo_root/scripts/cert/reset_fixtures.sh" duplicates >/dev/null
run_json import_duplicates import

# Stage C: empty fixture choreography
CERT_FIN_HOME="$fin_home" RESET_DB=1 "$repo_root/scripts/cert/reset_fixtures.sh" empty >/dev/null
